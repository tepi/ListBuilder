...
public class VListBuilder extends Composite
	...
	public VListBuilder() {
		...
		moveButtons.addStyleName(CLASSNAME + "-updown-buttons");
		...
		captionWrapper.addStyleName(CLASSNAME + "-caption-wrapper");
		...
		contentWrapper.addStyleName(CLASSNAME + "-content-wrapper");
		contentWrapper.add(options);
		contentWrapper.add(buttons);
		contentWrapper.add(selections);
		contentWrapper.add(moveButtons);
	...
	/**
	 * Clear selections and update button states if selection is changed in either
	 * ListBox
	 */
	 ...
	 * 
	 * @param box        ListBox to clear
	 * @param fixButtons true to update button states also
	 */
	...
	/**
	 * Moves currently selected items in the selections ListBox. If the selection is
	 * non-existent or invalid, nothing will be done.
	 * 
	 * @param up true to move items up, false to move items down
	 */
	...
	/**
	 * A custom extension of VButton, replacing the caption span with a DIV to allow
	 * creating VButtons containing an image in client side code.
	 */
