...
import org.tepi.listbuilder.gwt.client.ui.VListBuilder;
...
@ClientWidget(org.tepi.listbuilder.gwt.client.ui.VListBuilder.class)
        ...
        if (newValue == null) {
            ...
            if (newValue instanceof Collection) {
                ...
                throw new Property.ConversionException(
                        "ListBuilder only accepts values assignable to java.util.Collection.");
            }
        }
    }
