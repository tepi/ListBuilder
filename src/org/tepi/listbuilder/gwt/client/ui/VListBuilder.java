package org.tepi.listbuilder.gwt.client.ui;
...
public class VListBuilder extends Composite implements Paintable, Field,
        ClickHandler, ChangeHandler, Focusable, KeyDownHandler,
        DoubleClickHandler, SubPartAware {
    ...
    private void fixButtonStates() {
        ...
        add.setEnabled(isOptionSelected());
        remove.setEnabled(enableRemoveButton);
        down.setEnabled(!isLastSelected() && enableRemoveButton
                && continuousSelection);
        up.setEnabled(!isFirstSelected() && enableRemoveButton
                && continuousSelection);
    }
